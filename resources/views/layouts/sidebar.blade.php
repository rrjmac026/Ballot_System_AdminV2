    ...
    <div class="p-4 space-y-2">
        ...
        <a href="{{ route('voters.index') }}"
         ...
         <a href="{{ route('feedback.index') }}"
           class="flex items-center gap-3 px-3 py-2 text-sm rounded-lg transition-colors duration-200 {{ request()->routeIs('feedback.*') ? 'bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
            <i class="fas fa-user-check w-5 h-5"></i>
